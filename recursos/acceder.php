...
$userPOST = $_POST["inputEmail"]; 
$passPOST = $_POST["inputPassword"];
//println($userPOST);
//println($passPOST);
...
$consulta = "SELECT * FROM mmv005 WHERE username='".$userPOSTMinusculas."'";
...
//Además, hay un script que vacía los campos con la clase "acceso" (formulario)
	...
	<br> Los datos de acceso son incorrectos<br>');
} else {
	die('Error');
};
?>